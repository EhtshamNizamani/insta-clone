          ...
          Expanded(
            child: TextField(
              ...
              decoration: const InputDecoration(
                  hintText: 'Post a comment', border: InputBorder.none),
            ),
          ),
          TextButton(
              onPressed: () async {
                await FirestoreMethod().postComment(user.uid, widget.postId,
                    commentController.text, user.username, user.photoUrl);
